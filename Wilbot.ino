...
/* bits to add
 *  if (.5 < gap && gap < 1)  for happy or sad face temperature range
 *  auto config on power up with button pressed
 *  change settings from node red
 * 
sound
 *  
 */
...
const byte face_font [][8] PROGMEM = {
 ...
 {0x98, 0x5c, 0xb6, 0x5f, 0x5f, 0xb6, 0x5c, 0x98},//  invader 1
 {0x18, 0xdc, 0x36, 0x5f, 0x5f, 0x36, 0xdc, 0x18},// invader 1 
 {0x78, 0x3c, 0xf7, 0x3c, 0x3c, 0xf7, 0x3c, 0x78},// invader2
 {0x1e, 0x3c, 0xf7, 0x3c, 0x3c, 0xf7, 0x3c, 0x1e} //invader 2
};
